...
kable(highest_rentals_r, caption = "Films rented for the highest dollar value (R version)")
```
...
kable(highest_rentals_sql, caption = "Films rented for the highest dollar value (SQL version)")
```
